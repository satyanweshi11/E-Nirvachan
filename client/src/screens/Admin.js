      ...
      {loading ? (
        ...
        <Box>
          <Grid container sx={{ mt: 0 }} spacing={4}>
            <Grid item xs={12}>
              <Typography align="center" variant="h6" color={'orange'} fontFamily={'Bruno ace'}>
                ELECTION STATUS :{" "}
            ...
            {electionState !== 2 && (
              <Grid item xs={12} sx={{ display: "flex" }}>
                <Button
                  ...
                  onClick={handleEnd}
                >
                  <Typography fontFamily={'Iceland'} borderColor={'red'} color={'white'}>
            ...
            <Grid item xs={12}>
              <Typography align="center" variant="h6" fontFamily={'Bruno ace'} color={'green'}>
